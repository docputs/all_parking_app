...
// Reference Implementation: https://github.com/siqwin/mask_text_input_formatter/blob/5c424b6b39343f144a9aa5bf01d98195d2f441d8/lib/mask_text_input_formatter.dart
class MaskTextInputFormatter extends TextInputFormatter {
  ...
  TextEditingValue updateMask(String mask, {Map<String, RegExp> filter}) {
    ...
    _resultTextMasked = "";
    return _formatUpdate(TextEditingValue(),
        TextEditingValue(text: unmaskedText, selection: TextSelection(baseOffset: unmaskedText.length, extentOffset: unmaskedText.length)));
  }
